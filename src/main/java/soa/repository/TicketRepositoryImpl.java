...
import static soa.utils.UrlParametersUtil.parseInteger;
...
//    }
    ...
    @Override
    public PagedTicketList findAll(Integer perPage, Integer curPage, String sortBy, String filterBy) {
    ...
    private List<Ticket> findAll(Integer pageSize, Integer pageNumber, CriteriaQuery<Ticket> select) {
